...
const REF = "dist/property/room-in-a-6-bedroom-apartment-323-cleveland-street-surry-hills-sydney-2010-1632456/index.html"; // 参考页（已构建产物里的一篇真实文章页）
const SEG = "property";
const DEFAULT_OG = "https://unistay.net/og.png"; // 站点默认 og 图（绝对 URL，可为空串）
