---
title: "Housing near University of Oslo: 2026 student guide"
...
draft: false
---
<script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"1. How far in advance should I start looking for housing near the University of Oslo?","acceptedAnswer":{"@type":"Answer","text":"Start your search at least 4–6 months before your programme begins. For the autumn semester (starting August), many students start looking in March–April. SiO applications often open in February. For private rentals, listings appear about 2–3 months before the move-in date, but demand is high. If you arrive late without housing, you may need to book temporary accommodation (like a hostel or Airbnb) while searching."}},{"@type":"Question","name":"2. Is on-campus housing available, and who can apply?","acceptedAnswer":{"@type":"Answer","text":"The University of Oslo does not own dormitories directly; instead, student housing is provided by the student welfare organisation (SiO). SiO operates multiple housing sites near Blindern and across Oslo. International degree students and exchange students can apply through SiO. Priority is often given to newly admitted students. Some private residences also cater to students. It is advisable to apply to SiO as soon as you receive your admission letter."}},{"@type":"Question","name":"3. What documents do I need to rent a place in Oslo?","acceptedAnswer":{"@type":"Answer","text":"Landlords typically require: a copy of your passport/ID, proof of enrolment or student visa, income statements (or a guarantor), and a deposit payment (usually 3 months’ rent) into a deposit account (depositumskonto). If you are renting through SiO, they will ask for your admission letter and a photo. For private rentals, you may also need a Norwegian national identity number (fødselsnummer) or a D-number if you don’t have a permanent residence permit yet. Check with the landlord in advance.  *Data as of 2026. Prices and availability are indicative — confirm with the operator.*  See also: listing details · browse more"}}]}</script>

## Housing Near the University of Oslo: A Guide for Students
...
- **Shared accommodation (rooms in apartments or student corridors):** Often the most affordable option. Monthly rents are indicative — confirm with the operator. Most shared units include a private bedroom with shared kitchen and bathroom.
- **Studio apartments (single-person flats):** Higher cost, offering full privacy and a kitchenette. Again, indicative pricing only — confirm with the operator.
- **Student housing through official organisations (e.g., SiO):** Usually cheaper than private rentals and comes with standardised contracts. Waiting lists can be long.
- **Private market apartments:** Expect higher deposits (often 3–6 months’ rent) and tenant screening. Monthly costs vary by neighbourhood.
...
- **Walkable areas (within 15–20 minutes):** Blindern itself, Majorstuen, and parts of Frogner and Bislett. These neighbourhoods tend to have higher rents, but you save on transport time and monthly travel costs. If you value library late nights and easy access to on-campus events, a short walk is ideal.
- **Transit-dependent areas:** Districts such as Grünerløkka, Tøyen, Sagene, or further out like Kjelsås or Økern. Here, you rely on metro (T-bane), tram, or bus. The commute to Blindern is typically 20–40 minutes door-to-door. Rents are generally lower, but you need a monthly transport pass or bike. Bicycle infrastructure is good in Oslo, especially during warmer months.
...
- SiO student villages near Blindern (like Kringsjå or Sogn) – close to campus, fixed-priced, but competitive.
- Private apartments in Majorstuen (10 minutes walk) – higher rent but very convenient.
- Shared flats in Grünerløkka (20–30 minutes transit) – lower rent, lively area, slightly longer commute.
- Rooms in Bislett (15 minutes walk or one tram stop) – balanced cost and distance.
